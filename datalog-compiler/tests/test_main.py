...
class TestMain(unittest.TestCase):
    ...
    def test_recursive_query(self):
        ...
        expected_translated_queries = [
            ...
            "CREATE VIEW reachable AS WITH reachable (z0, z1) AS ((SELECT link.z0, link.z1 FROM link) UNION DISTINCT (SELECT link.z0, reachable.z1 FROM link, reachable WHERE link.z1=reachable.z0)) SELECT * FROM reachable;",
